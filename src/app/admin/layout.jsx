...
const baseNav = [
  ...
  { href: '/admin/usuarios', label: 'Usuarios', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  { href: '/admin/canchas', label: 'Canchas', icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z' },
...
export default function AdminLayout({ children }) {
  ...
  useEffect(() => {
    ...
    if (hasToken) {
      // Decode JWT payload to get role (no verification needed client-side)
      try {
      ...
      <header className="gradient-brand text-white shadow-lg">
        <div className="w-full px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <img src={LOGO_URL} alt="Partidos ABC" className="w-8 h-8 rounded-full object-cover border-2 border-white/30" />
            <div>
