...
export default function UploadReceipt({ onUpload }) {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        {preview ? (
          <img src={preview} alt="Comprobante" className="max-h-48 mx-auto rounded" />
        ) : (
          <div className="space-y-2 py-4">
            <svg className="w-8 h-8 mx-auto text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
